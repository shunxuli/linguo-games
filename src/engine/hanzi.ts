...
export const hanziData: HanziItem[] = [
  ...
  { char: '九', pinyin: 'jiǔ', meaning: '九个', emoji: '9️⃣', difficulty: 1,
  ...
  { char: '王', pinyin: 'wáng', meaning: '国王', emoji: '👑', difficulty: 1,
  ...
  { char: '风', pinyin: 'fēng', meaning: '风', emoji: '💨', difficulty: 2,
    oracleSvg: '<path d="M25 50 Q40 25 50 50 Q60 25 75 50" fill="none" stroke="#333" stroke-width="3"/>' },
  { char: '花', pinyin: 'huā', meaning: '花朵', emoji: '🌸', difficulty: 2,
  ...
  { char: '车', pinyin: 'chē', meaning: '车辆', emoji: '🚗', difficulty: 2,
  ...
  { char: '龙', pinyin: 'lóng', meaning: '龙', emoji: '🐉', difficulty: 2,
  ...
  { char: '虫', pinyin: 'chóng', meaning: '虫子', emoji: '🐛', difficulty: 2,
  ...
  { char: '父', pinyin: 'fù', meaning: '父亲', emoji: '👨', difficulty: 2,
  ...
  { char: '母', pinyin: 'mǔ', meaning: '母亲', emoji: '👩', difficulty: 2,
  ...
  { char: '同', pinyin: 'tóng', meaning: '相同', emoji: '🤝', difficulty: 2,
  ...
  { char: '开', pinyin: 'kāi', meaning: '打开', emoji: '🔓', difficulty: 2,
  ...
  { char: '正', pinyin: 'zhèng', meaning: '端正', emoji: '✅', difficulty: 2,
  ...
  { char: '问', pinyin: 'wèn', meaning: '问答', emoji: '❓', difficulty: 2,
  ...
  { char: '春', pinyin: 'chūn', meaning: '春天', emoji: '🌱', difficulty: 2,
  ...
  { char: '古', pinyin: 'gǔ', meaning: '古老', emoji: '🏛️', difficulty: 2,
  ...
  { char: '年', pinyin: 'nián', meaning: '年份', emoji: '📅', difficulty: 3,
  ...
  { char: '声', pinyin: 'shēng', meaning: '声音', emoji: '🔊', difficulty: 3,
  ...
  { char: '金', pinyin: 'jīn', meaning: '金子', emoji: '🥇', difficulty: 3,
  ...
  { char: '身', pinyin: 'shēn', meaning: '身体', emoji: '🧍', difficulty: 3,
  ...
  { char: '面', pinyin: 'miàn', meaning: '脸面', emoji: '😊', difficulty: 3,
  ...
  { char: '亮', pinyin: 'liàng', meaning: '明亮', emoji: '🔆', difficulty: 3,
  ...
  { char: '前', pinyin: 'qián', meaning: '前面', emoji: '⬅️', difficulty: 3,
  ...
  { char: '后', pinyin: 'hòu', meaning: '后面', emoji: '➡️', difficulty: 3,
  ...
  { char: '左', pinyin: 'zuǒ', meaning: '左边', emoji: '👈', difficulty: 3,
  ...
  { char: '右', pinyin: 'yòu', meaning: '右边', emoji: '👉', difficulty: 3,
  ...
  { char: '家', pinyin: 'jiā', meaning: '家人', emoji: '🏠', difficulty: 3,
  ...
  { char: '衣', pinyin: 'yī', meaning: '衣服', emoji: '👕', difficulty: 3,
  ...
  { char: '食', pinyin: 'shí', meaning: '食物', emoji: '🍽️', difficulty: 3,
  ...
  { char: '秋', pinyin: 'qiū', meaning: '秋天', emoji: '🍂', difficulty: 3,
  ...
  { char: '礼', pinyin: 'lǐ', meaning: '礼物', emoji: '🎁', difficulty: 3,
...
export const hanziDifficulties: Record<number, { name: string; count: number; score: number }> = {
  1: { name: '入门', count: 31, score: 10 },
  2: { name: '简单', count: 30, score: 20 },
  3: { name: '困难', count: 39, score: 35 },
}
