...
export const TANGRAM_TARGETS: TangramTarget[] = [
  ...
  { name: '三角形', category: 'other', image: 'tangram/triangle.png', score: 15 },
  { name: '滑冰者', category: 'other', image: 'tangram/skater.png', score: 15 },
  { name: '骑车人', category: 'other', image: 'tangram/cyclist.png', score: 15 },
]
